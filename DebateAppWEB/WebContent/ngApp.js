var app = angular.module('ngDebate', ['ngRoute','ui.bootstrap','vAccordion', 'ngAnimate','luegg.directives','ngMaterial']); //ngRoute and 'ui.bootstrap' are module dependencies
