...
public class CommentController implements CommentControllerI {
	...
	// and returning updated comment from DAO
	...
	// Respond to request by passing JSON for new comment to DAO and returning
	...
	// Respond to request by destroying/deleting specific comment and returning
	// deleted comment information back to front end's angular asynchronous
	// service
